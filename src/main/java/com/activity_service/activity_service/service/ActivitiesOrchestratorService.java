...
public class ActivitiesOrchestratorService {
    ...
    private JSONObject validateActivityRequest(String activitiesRequestId, ActivitiesRequest activityRequest) {
        ...
        try{
            ...
            ResponseEntity<String> responseEntity = restTemplate.exchange("http://validation-service/v1/risk/validation", HttpMethod.POST,validationReqEntity,String.class);
